...
# reprojecting to espg3857 using gdalwarp
# too lazy to do it from scratch inside python
print "Reprojecting image"
call(["gdalwarp", "-t_srs", "epsg:3857", "-dstnodata", "0", "-r", "cubic", nome_saida_tmp, nome_saida], shell=False)
